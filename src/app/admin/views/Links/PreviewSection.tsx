...
export const PreviewSection = ({
  ...
  return (
    <div
      className={twMerge(
        "flex h-full w-full flex-col items-start justify-center gap-4 border-l border-gray-300 px-4",
        className,
      )}
      {...props}
    >
      ...
      <div className="m-auto flex aspect-[9/16] h-full flex-col items-center justify-start gap-4 rounded-3xl border-[8px] border-black p-4 pt-12">
        <span className="h-16 w-16 rounded-full bg-red-300" />
        ...
        {links.map(({ title, url, isActive }) => {
          ...
          return (
            ...
            >
              ...
              <ArrowSquareOut size={20} className={twMerge("text-gray-600")} />
            </a>
          );
        })}
      </div>
